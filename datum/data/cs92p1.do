* Stata-commands to read and label cs92p1.dat

capture infile /*
*/byte i01       byte i02       byte ise       byte i03       int i04       byte i05       int i06      /*
*/byte i07       byte i08       int i09       int i10       int i13       byte typ       int p00      /*
...
*/byte p06nue    byte p07nue    byte p08nue    byte urba      byte micondix  byte cond      int cobl     /*
*/byte caebl     byte sitemp    byte filter__  using cs92p1.dat
...
capture label variable urba "AREA GEOGRÁFICA" 
capture label value urba urba 
capture label variable micondix "Condición de actividad 92" 
capture label value micondix micondix 
capture label variable cond "Cond DESDE 7" 
capture label value cond cond 
capture label variable cobl "COB 1 digito" 
capture label value cobl cobl 
capture label variable caebl "CAEB 1 DIGITO" 
capture label value caebl caebl 
capture label variable sitemp "Situación en el empleo" 
capture label value sitemp sitemp 
capture label variable filter__ "micondix = 1 (FILTER)" 
capture label value filter__ filter__ 
label define filter__ 0 `"Not Selected"', modify
label define filter__ 1 `"Selected"', modify
label define sitemp 1 `"obrero o empleado"', modify
label define sitemp 2 `"Cuenta propia"', modify
label define sitemp 3 `"Patrón"', modify
label define sitemp 4 `"Cooperativista"', modify
label define sitemp 5 `"Trab fam"', modify
label define sitemp 9 `"sin especificar"', modify
label define caebl 1 `"AGRIC, GANAD, CAZA Y SILVIC"', modify
label define caebl 2 `"PESCA"', modify
label define caebl 3 `"EXPLOTACIÓN MINAS Y CANTERAS"', modify
label define caebl 4 `"IND MANUFACTURERA"', modify
label define caebl 5 `"ELECTRICIDAD, GAS Y AGUA"', modify
label define caebl 6 `"CONSTRUCCIÓN"', modify
label define caebl 7 `"COMERCIO POR MAYOR, POR MENOR Y REPARACIONES"', modify
label define caebl 8 `"HOTELES Y RESTURANTES"', modify
label define caebl 9 `"TRANSPORTE, ALMACENAMIENTO Y COMUNIC"', modify
label define caebl 10 `"INTERMEDIACIÓN FINANCIERA"', modify
label define caebl 11 `"SERV INMOVILIARIOS, EMPRESARIALES Y DE ALQUILER"', modify
label define caebl 12 `"ADM PUBLICA, DEFENSA, SEG SOC"', modify
label define caebl 13 `"EDUCACIÓN"', modify
label define caebl 14 `"SERV SOC Y DE SALUD"', modify
label define caebl 15 `"SERV COMUNITARIOS, SOC Y PERSONALES"', modify
label define caebl 16 `"HOGARES PRIVADOS"', modify
label define caebl 17 `"ORGANIZACIONES EXTRATERRITORIALES"', modify
label define caebl 99 `"SIN ESPECIFICAR"', modify
label define cobl 0 `"Fuerzas armadas"', modify
label define cobl 1 `"direc adm pub"', modify
label define cobl 2 `"prof cient intel"', modify
label define cobl 3 `"tec y prof de apoyo"', modify
label define cobl 4 `"emp of"', modify
label define cobl 5 `"trab serv y vendedores"', modify
label define cobl 6 `"agric"', modify
label define cobl 7 `"ind extrac, cons, manyfac"', modify
label define cobl 8 `"op instalac"', modify
label define cobl 9 `"trab no calif"', modify
label define cobl 999 `"sin especificar"', modify
label define cond 0 `"PENT (menores de 7)"', modify
label define cond 1 `"PO"', modify
label define cond 2 `"C"', modify
label define cond 3 `"A"', modify
label define cond 4 `"PEI"', modify
label define cond 9 `"SIN ESPECIFICAR"', modify
label define micondix 0 `"PENT"', modify
label define micondix 1 `"PO"', modify
label define micondix 2 `"C"', modify
label define micondix 3 `"A"', modify
label define micondix 4 `"PEI"', modify
label define micondix 9 `"SIN ESPECIFICAR"', modify
