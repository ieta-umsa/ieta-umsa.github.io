* Stata-commands to read and label cs76p1.dat

capture infile /*
*/byte dep       byte pro       byte can       byte ciu       byte area      byte zona      int v00      /*
*/int p00       byte p02       byte p03       byte p04       int p07       int p06       int p08      /*
*/byte p09       byte p10       byte p11       int p14       byte p15       int p16       int p17      /*
*/byte p18       byte p20       byte p21       byte p23m      int p23a      byte p05       int i10p     /*
*/byte i13p      byte p06nue    byte p07nue    byte p08nue    long folio     using cs76p1.dat
